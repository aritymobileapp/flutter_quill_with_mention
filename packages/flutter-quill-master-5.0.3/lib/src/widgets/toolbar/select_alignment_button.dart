...
class _SelectAlignmentButtonState extends State<SelectAlignmentButton> {
  ...
  Widget build(BuildContext context) {
    ...
    final buttonCount =
        ((widget.showLeftAlignment!) ? 1 : 0) + ((widget.showCenterAlignment!) ? 1 : 0) + ((widget.showRightAlignment!) ? 1 : 0) + ((widget.showJustifyAlignment!) ? 1 : 0);
          ...
          child: ConstrainedBox(
            ...
            child: RawMaterialButton(
              ...
              fillColor: _valueToText[_value] == _valueString[index]
                  ? (widget.iconTheme?.iconSelectedFillColor ?? Theme.of(context).colorScheme.secondary)
